...
testusuarioConMasAmigos = test [
    "Caso 1: Con igual cantidad de amigos -- que otro usuario" ~: (usuarioConMasAmigos redG) ~?= (12, "Julian"),
    "Caso 1: Con igual cantidad de amigos ++ que otro usuario" ~: (usuarioConMasAmigos redC) ~?= (2, "Natalia"),
    "Caso 2: Usuario que tiene la mayor cantidad de amigos" ~: (usuarioConMasAmigos redF) ~?= (9,"Lucia")
    ]
...
testestaRobertoCarlos = test [
    ...
    "Caso 3 Existe un usuario con mas de 10 amigos" ~: (estaRobertoCarlos redF ) ~?= True
    ]
...
--redC 
relacionesC = [relacion1_2, relacion2_3, relacion2_5, relacion4_2, relacion3_4, relacion4_5, relacion5_6, relacion6_7, relacion7_8]
...
publicacionesDeUnUsuario = [publicacion3_3]
...
publicacionesE = [publicacion1_4]
redE= (usuariosE, relacionesE, publicacionesE)

--redF (Conmuchasrelaciones)
...
publicacionesF = []-- no olvidar agregar publis asi lo uso para el ejercicio de publis 6 o 7!!
redF = (usuariosF, relacionesF, publicacionesF)

--redG (Con solo dos usuarios)
usuarios2 =[usuario7, usuario12]
relacionesG = []
publicacionesG = []
redG = (usuarios2, relacionesG, publicacionesG)